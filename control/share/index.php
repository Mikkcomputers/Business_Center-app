...
if ($res) {
    ...
    <script>
        ...
        .then((res)=>{window.location='../share/'})
    </script>
    ";
}else{
    echo"
...
if (isset($_POST['btn_update'])){
    ...
    $mount = $_POST['amount'];
 $sql = "UPDATE share SET `username` = '$sername', `amount` = $mount WHERE id = $hidden";
$res = $conn->query($sql);
if ($res) {
    echo "<script>
            ...
            <div class="container  " style="color:maroon">
                <!-- <div class="row "> -->
                    <!-- <div class="col-md- p-5"> -->
                        <?php if($update == true){ ?>
                        <h3 class="text-center  mb-3 mt-5">Updating Sharing</h3>
                        <?php }else{ ?>
                        <h3 class="text-center  mb-3 mt-5">Sharing</h3>
                        <?php } ?>
                        <form action="index.php" method="post">
                        <input type="hidden" name="hidden" value="<?=$rows['id']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input name="amount" value="<?=$amount; ?>" type="number" class="form-control mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <?php }else{?>
                                <button name="btn_share" class="btn btn-danger form-control mt-3">Share</button>
                                <?php }?>
                            </div>
                        </form>
                    </div>
