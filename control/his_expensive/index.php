...
<body class="">
    <div class="container1">
        ...
        <section class="" style="border: none;">
            ...
            <!-- <div class="row" > -->
                    <!-- <div class="con"> -->
                        <h3 class="text-center  mb-2">Expensive History</h5>
                        <table class="table table-striped text-danger table-light table-hover">
                            ...
                            <?php
                                $sn = 1;
                                $sql = "SELECT * FROM expensive";
                                $res = $conn->query($sql);
                               while($data = $res->fetch_assoc()){
                                ?>
                            <tr>
                                <td><?=$sn++ ?></td>
                                <td><?=$data['expensive_name']; ?></td>
                                <td><?=$data['amount']; ?></td>
                                <td><?=$data['date']; ?></td>
                                <td><a style="color:red; font-size:25px" href="delete.php?del=<?=$data['id']; ?>"><i class="la la-trash"></i></a></td>
                                <td><a style="color:blue; font-size:25px" href="../expensive?edit=<?=$data['id']; ?>"><i class="la la-edit"></i></a></td>
                            </tr>
                            <?php
                           }
                            ?>
